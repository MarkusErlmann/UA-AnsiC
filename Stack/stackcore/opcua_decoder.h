 ...
 *===========================================================================*/
/* This is still an aliasing violation, but it is only used on the EnumeratedArrayTestType.  */
#define OpcUa_Field_ReadEnumeratedArray(xType, xName) \
{ \
    OpcUa_GotoErrorIfTrue(sizeof(xType) != sizeof(OpcUa_Int32), OpcUa_BadInternalError); \
